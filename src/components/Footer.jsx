...
<p style={styles.contactText}>
  <strong>Email:</strong>{" "}
  <a
    href="mailto:info@amaniautomation.com"
    style={styles.contactLink}
  >
    info@amaniautomation.com
  </a>
</p>
  ...
  >
    ...
    Hyderabad, Telangana, 502319
        ...
        <div style={styles.column}>
          ...
          <Link to="/signup">
            <button className="footer-join-btn" style={styles.joinBtn}>Join AMANI</button>
          </Link>
        </div>
...
const styles = {
  footer: {
    width: "100%",
    backgroundColor: "#11306D", // Matches the Hero and About background
    padding: "80px 0 0 0",
    color: "#FFFFFF",
